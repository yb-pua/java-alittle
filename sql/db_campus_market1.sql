/*
 ...
 Date: 26/04/2023 22:32:55
*/

DROP DATABASE IF EXISTS db_campus_market ;
CREATE DATABASE db_campus_market CHARACTER SET utf8;
use db_campus_market ;
...
INSERT INTO `ylrc_comment` VALUES (16, '2023-04-24 13:17:02', '2023-04-24 13:17:02', '111', NULL, 21, 2);
...
CREATE TABLE `ylrc_database_bak`  (
  ...
  `create_time` datetime(0) NOT NULL,
  `update_time` datetime(0) NOT NULL,
  `filename` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = COMPACT;
...
INSERT INTO `ylrc_goods` VALUES (21, '2020-04-11 21:23:09', '2023-04-24 13:17:04', 2980, '1.型号要求：艺卓mx191 \r\n2.到手时间/使用时长：2016年12月产 \r\n3.成色描述：95新 \r\n4.器材情况：带配件公司替换品 \r\n5.包含配件：说明书，cd，电源线，数据线 \r\n6.其他说明：可直接微信：Allenfindu.邮费顺丰到付，可小刀。', 0, '艺卓MX191显示器', '20200411/1586611370203.jpg', 0, 1980, 1, 24, 3, 7);
...
INSERT INTO `ylrc_goods` VALUES (25, '2020-04-11 21:31:27', '2023-03-03 18:05:38', 37, '【品名】克洛斯威/crossway \r\n【名称】克洛斯威-乒乓球6星拍\r\n【货号】1122带球带拍套带护边贴\r\n【打法分类】攻防兼备型\r\n【底板材质】椴木5层\r\n【厚度】14.5mm\r\n【包套材料】拍包+6个乒乓球+1个护边贴', 0, '克洛斯威六星乒乓球拍', '20200411/1586611861285.jpg', 1, 27, 1, 29, 2, 2);
...
-- ----------------------------
INSERT INTO `ylrc_news` VALUES (1, '2020-04-16 21:29:17', '2023-03-03 16:51:48', '推荐给你们认识的朋友吧！！！', 2, '关于校园二手市场平台', 0);
INSERT INTO `ylrc_news` VALUES (2, '2020-04-16 21:29:49', '2023-03-03 16:20:11', '1.禁止和限制发布物品管理规则\r\n2.重复铺货商品管理规则\r\n3.支付方式不符商品管理规则\r\n4.商品价格、邮费不符商品管理规则\r\n5.信用炒作商品管理规则', 0, '校园二手市场发布商品规则', 6);
INSERT INTO `ylrc_news` VALUES (3, '2020-04-16 21:30:22', '2023-04-24 13:17:12', '注册时请填写详细的注册信息，学号为必填项。', 1, '校园二手市场账号注册规则', 6);
...
CREATE TABLE `ylrc_operater_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 525 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = COMPACT;
...
INSERT INTO `ylrc_operater_log` VALUES (517, '2023-03-03 16:17:13', '2023-03-03 16:17:13', '用户【admin】于【2023-03-03 16:17:12】登录系统！', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (518, '2023-03-03 16:45:31', '2023-03-03 16:45:31', '用户【admin】于【2023-03-03 16:45:30】登录系统！', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (519, '2023-03-03 16:46:06', '2023-03-03 16:46:06', '编辑友情链接：FriendLink [name=金银的豆子, url=https://www.baidu.com/, sort=0]', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (520, '2023-03-03 16:47:31', '2023-03-03 16:47:31', '修改网站设置:SiteSetting [siteName=校园二手市场, siteUrl=https://www.baidu.com/, logo1=20210307/1615096736988.png, logo2=20200418/1587201663687.png, qrcode=20210223/1614075844201.png, allRights=金银的豆子]', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (521, '2023-03-03 16:50:26', '2023-03-03 16:50:26', '用户【admin】于【2023-03-03 16:50:26】登录系统！', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (522, '2023-03-03 16:50:34', '2023-03-03 16:50:34', '修改网站设置:SiteSetting [siteName=校园二手市场, siteUrl=https://www.baidu.com/, logo1=20210307/1615096736988.png, logo2=20200418/1587201663687.png, qrcode=20210223/1614075844201.png, allRights=金银的豆子]', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (523, '2023-03-03 16:51:48', '2023-03-03 16:51:48', '编辑新闻公告：News [title=关于校园二手市场平台, content=推荐给你们认识的朋友吧！！！, viewNumber=0, sort=2]', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (524, '2023-03-03 17:01:41', '2023-03-03 17:01:41', '用户【admin】于【2023-03-03 17:01:41】登录系统！', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (525, '2023-04-24 12:57:15', '2023-04-24 12:57:15', '用户【admin】于【2023-04-24 12:57:15】登录系统！', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (526, '2023-04-26 22:31:45', '2023-04-26 22:31:45', '用户【admin】于【2023-04-26 22:31:44】登录系统！', 'admin');
INSERT INTO `ylrc_operater_log` VALUES (527, '2023-04-26 22:31:53', '2023-04-26 22:31:53', '批量删除友情链接，友情链接IDS：11', 'admin');
...
-- ----------------------------
INSERT INTO `ylrc_site_setting` VALUES (1, '2020-04-18 17:02:17', '2023-03-03 16:50:34', '金银的豆子', '20210307/1615096736988.png', '20200418/1587201663687.png', '20210223/1614075844201.png', '校园二手市场', 'https://www.baidu.com/');
...
CREATE TABLE `ylrc_student`  (
  ...
  `create_time` datetime(0) NOT NULL,
  `update_time` datetime(0) NOT NULL,
  `academy` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
